...
> Exercise as medicine for chronic disease, mental health, aging, and sleep management

## Entities

| Entity | Description | Tags |
|--------|-------------|------|
| [[entities/exercise-science/health/exercise-disease]] | Exercise as Medicine: chronic disease prevention, exercise prescription | exercise-science, health |
...
- [[physiology-index]] — Physiological adaptations from training drive health outcomes
- [[supplements-index]] — Supplements (curcumin for inflammation, CoQ10 for cardiovascular) complement exercise therapy for disease
- [[nutrition-index]] — Dietary interventions synergize with exercise for metabolic health (diabetes, MAFLD)
- [[running-index]] — Aerobic exercise (running) is a primary modality for cardiovascular and metabolic health
