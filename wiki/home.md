...
| Index | Domain | Entities |
|-------|--------|----------|
| [[running-index]] | Running economy, trail running, ultra-endurance, trail injuries, trail psychology | 5 |
| [[biomechanics-index]] | Gait analysis, running shoes, cadence/stride, gait biomechanics, fascia-mobility-training, injury biomechanics | 6 |
...
| Index | Domain | Entities |
|-------|--------|----------|
| [[exercise-health-index]] | Exercise as medicine, chronic disease, mental health, kinesiophobia, meditation, aging/sarcopenia, sleep, gut-barrier-function | 12 |
...
| [[sources/relay-neuron-physiology]] | 运动生理学：肌肥大、mTOR、GATOR2/BFBOX2/ILF3机制、冷热疗法、免疫、表观遗传、神经驱动、疲劳机制、线粒体功能、颈动脉体（~60主题）| 2026-05 |
...
| [[sources/relay-neuron-technology]] | 可穿戴设备、HRV监控、跑步功率计、AI/ML预测、生物黑客可穿戴设备（HRV生物反馈、CGM、AI 78-92%准确率）（~20主题）| 2026-05 |
...
| [[sources/relay-neuron-biomechanics]] | 跑步生物力学：步态分析、步频步幅、损伤生物力学、跑鞋、软组织修复、筋膜训练、步态生物力学重训练风险（~15主题）| 2026-05 |
...
| [[sources/relay-neuron-mitochondrial]] | 线粒体生物能量学：ETC Complex I-V、NAD+代谢、有丝分裂、ROS与氧化应激（2024-2026）| 2026-05 |
| [[sources/relay-neuron-mtor-pathway]] | mTOR通路深入研究：GATOR2/ILF3/FBXO2机制、亮氨酸阈值、过度激活风险（2026-05）| 2026-05 |
| [[sources/relay-neuron-carotid-body]] | 颈动脉体生理学：VO2max适应性、K+通道、CIH协同、敏感性调节（2024-2026）| 2026-05 |
| [[sources/relay-neuron-exercise-genetics]] | 运动遗传学：ACTN3/ACE/PPARGC1A多态性、基因个性化训练、遗传决定论误区（2024-2026）| 2026-05 |
| [[sources/relay-neuron-exercise-epigenetics]] | 运动表观遗传学：DNA甲基化、端粒长度、组织蛋白修饰（2024-2026）| 2026-05 |
